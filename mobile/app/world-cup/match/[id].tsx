...
// `score.home`/`score.away`. Passing `fixture` straight through left
// `ms.home`/`ms.away` undefined, so every live (non-finished) knockout match
// fell through to the `?? 0` fallback and showed a permanent 0-0 regardless
// of the real score.
