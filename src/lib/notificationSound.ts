...
export const SOUND_PRESETS_BY_CATEGORY: Record<
	SoundCategory,
	SoundPresetMeta[]
> = {
...
export const SOUND_CATEGORY_LABELS: Record<
	SoundCategory,
...
> = {
	...
	notification: {
		title: 'Bell',
		emoji: '🔔',
		hint: 'Plays for push / in-app notifications.',
	},
	message: {
		title: 'Messages',
		emoji: '💬',
		hint: 'Plays on new chat messages.',
	},
};
...
export function applySoundPreferences(
	...
	activePrefs = {
		voteSoundId:
			prefs.voteSoundId && isVoteSoundId(prefs.voteSoundId)
				? prefs.voteSoundId
				: activePrefs.voteSoundId,
		notificationSoundId:
			prefs.notificationSoundId &&
			isNotificationSoundId(prefs.notificationSoundId)
				? prefs.notificationSoundId
...
export function resolveSoundPreferences(
	input?: {
	...
	return {
		...
		notificationSoundId:
			...
			isNotificationSoundId(input.notificationSoundId)
				? input.notificationSoundId
				: cached.notificationSoundId &&
				  isNotificationSoundId(cached.notificationSoundId)
				? cached.notificationSoundId
...
export function syncSoundPreferences(
	input?: {
		voteSoundId?: string | null;
		notificationSoundId?: string | null;
		messageSoundId?: string | null;
