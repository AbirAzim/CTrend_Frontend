...
**Recent:** `2026-06-01_phase4-notifications.md` — avatars, grouped resurface,
friend-request status, comment deep-links.

Also: `2026-06-01_profile-drops-grid-and-search-thumbs.md` — **full design spec**
